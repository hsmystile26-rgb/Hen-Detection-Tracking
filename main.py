...
weights_path = os.path.join("model_data", "mask_rcnn_coco.h5")
...
def main():
    ...
    video_capture = cv2.VideoCapture(r"D:\ClumsyChickens-main\ClumsyChickens-main\20200412.avi")
    ...
    while True:
        ...
        frame = frame[...,::-1]
        cv2.imshow("ClumsyChickens", frame)
